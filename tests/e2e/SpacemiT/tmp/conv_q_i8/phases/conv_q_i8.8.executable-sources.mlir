...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  hal.executable private @conv_i8_quantized_dispatch_0 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @conv_i8_quantized_dispatch_0_generic_32x32x3x3x8_i8() {
          ...
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c0) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<1024x72xi8, #encoding>>
  ...
  hal.executable private @conv_i8_quantized_dispatch_1 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @conv_i8_quantized_dispatch_1_matmul_1024x16x72_i8xi8xi32() {
          %c0_i32 = arith.constant 0 : i32
          %c0 = arith.constant 0 : index
          %c73728 = arith.constant 73728 : index
          %0 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c0) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<1024x72xi8, #encoding>>
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c73728) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<72x16xi8, #encoding1>>
  ...
  hal.executable private @_encoding_0 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @_encoding_0_encode_72x16xi8_to_72x16xi8() {
          %c0 = arith.constant 0 : index
          %c73728 = arith.constant 73728 : index
          ...
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c73728) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<72x16xi8, #encoding1>>
