...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  flow.executable private @conv_i8_quantized_dispatch_0 {
    flow.executable.export public @conv_i8_quantized_dispatch_0_generic_32x32x3x3x8_i8 workgroups() -> (index, index, index) {
      %x, %y, %z = iree_tensor_ext.dispatch.workgroup_count_from_slice()
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @conv_i8_quantized_dispatch_0_generic_32x32x3x3x8_i8(%arg0: !iree_tensor_ext.dispatch.tensor<readonly:tensor<34x34x8xi8>>, %arg1: !iree_tensor_ext.dispatch.tensor<writeonly:tensor<1024x72xi8, #encoding>>) {
  ...
  flow.executable private @conv_i8_quantized_dispatch_1 {
    flow.executable.export public @conv_i8_quantized_dispatch_1_matmul_1024x16x72_i8xi8xi32 workgroups() -> (index, index, index) {
      %x, %y, %z = iree_tensor_ext.dispatch.workgroup_count_from_slice()
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @conv_i8_quantized_dispatch_1_matmul_1024x16x72_i8xi8xi32(%arg0: !iree_tensor_ext.dispatch.tensor<readonly:tensor<1024x72xi8, #encoding>>, %arg1: !iree_tensor_ext.dispatch.tensor<readonly:tensor<72x16xi8, #encoding1>>, %arg2: !iree_tensor_ext.dispatch.tensor<writeonly:tensor<1024x16xi32>>) {
  ...
  util.func public @conv_i8_quantized(%arg0: !hal.buffer_view, %arg1: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub, iree.reflection = {iree.abi.declaration = "sync func @conv_i8_quantized(%input0: tensor<1x34x34x8xi8>, %input1: tensor<3x3x8x16xi8>) -> (%output0: tensor<1x32x32x16xi32>)"}} {
    ...
    %3 = flow.dispatch @conv_i8_quantized_dispatch_0::@conv_i8_quantized_dispatch_0_generic_32x32x3x3x8_i8(%2) : (tensor<34x34x8xi8>) -> tensor<1024x72xi8, #encoding>
    ...
    %6 = flow.dispatch @conv_i8_quantized_dispatch_1::@conv_i8_quantized_dispatch_1_matmul_1024x16x72_i8xi8xi32(%3, %5) : (tensor<1024x72xi8, #encoding>, tensor<72x16xi8, #encoding1>) -> tensor<1024x16xi32>
