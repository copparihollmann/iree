...
@4 = internal constant [36 x i8] c"tests/e2e/SpacemiT/matmul_q_i8.mlir\00", align 1
@5 = internal constant [36 x i8] c"tests/e2e/SpacemiT/matmul_q_i8.mlir\00", align 1
@6 = internal constant [36 x i8] c"tests/e2e/SpacemiT/matmul_q_i8.mlir\00", align 1
@iree_hal_executable_library_query_v0_source_locations = internal constant [3 x %iree_hal_executable_source_location_v0_t] [%iree_hal_executable_source_location_v0_t { i32 1, i32 35, ptr @4 }, %iree_hal_executable_source_location_v0_t { i32 1, i32 35, ptr @5 }, %iree_hal_executable_source_location_v0_t { i32 1, i32 35, ptr @6 }]
...
define internal noundef i32 @matmul_i8_quantized_dispatch_0_matmul_32x32x64_i8xi8xi32(ptr noalias nonnull readnone align 16 captures(none) %0, ptr noalias noundef nonnull readonly align 16 captures(none) %1, ptr noalias noundef nonnull readonly align 16 captures(none) %2) #0 !dbg !10 {
  %.elt19 = getelementptr inbounds nuw i8, ptr %1, i64 32, !dbg !86
  %.unpack20 = load ptr, ptr %.elt19, align 16, !dbg !86
  %4 = load ptr, ptr %.unpack20, align 8, !dbg !86
  call void @llvm.assume(i1 true) [ "align"(ptr %4, i64 64) ], !dbg !86
  %5 = getelementptr i8, ptr %4, i64 2048, !dbg !86
  call void @llvm.assume(i1 true) [ "align"(ptr %5, i64 64) ], !dbg !86
  %6 = getelementptr i8, ptr %.unpack20, i64 8, !dbg !86
  ...
  %10 = lshr i64 %9, 1, !dbg !86
  %11 = and i64 %9, 1, !dbg !86
  %12 = shl nuw nsw i64 %11, 10
  %13 = getelementptr i8, ptr %5, i64 %12
  %14 = shl nuw nsw i64 %10, 9
  %15 = getelementptr inbounds nuw i8, ptr %4, i64 %14
  br label %16, !dbg !86

16:                                               ; preds = %3, %16
  %17 = phi [8 x <16 x i32>] [ zeroinitializer, %3 ], [ %87, %16 ]
  %18 = phi i64 [ 0, %3 ], [ %88, %16 ]
  %19 = shl nuw nsw i64 %18, 4, !dbg !86
  %20 = getelementptr i8, ptr %13, i64 %19, !dbg !86
  %21 = load <16 x i8>, ptr %20, align 16, !dbg !86
  %22 = extractvalue [8 x <16 x i32>] %17, 0
  %23 = extractvalue [8 x <16 x i32>] %17, 1
  %24 = extractvalue [8 x <16 x i32>] %17, 2
  %25 = extractvalue [8 x <16 x i32>] %17, 3
  %26 = extractvalue [8 x <16 x i32>] %17, 4
  %27 = extractvalue [8 x <16 x i32>] %17, 5
  %28 = extractvalue [8 x <16 x i32>] %17, 6
  %29 = extractvalue [8 x <16 x i32>] %17, 7
  %30 = tail call <vscale x 4 x i8> @llvm.vector.insert.nxv4i8.v16i8(<vscale x 4 x i8> undef, <16 x i8> %21, i64 0)
  %31 = shl nuw nsw i64 %18, 3
  %32 = getelementptr inbounds nuw i8, ptr %15, i64 %31
  %33 = load i8, ptr %32, align 8
  %34 = tail call <vscale x 4 x i16> @llvm.riscv.vwmul.nxv4i16.nxv4i8.i8.i64(<vscale x 4 x i16> undef, <vscale x 4 x i8> %30, i8 %33, i64 16)
  %35 = getelementptr inbounds nuw i8, ptr %32, i64 1
  %36 = load i8, ptr %35, align 1
  %37 = tail call <vscale x 4 x i16> @llvm.riscv.vwmul.nxv4i16.nxv4i8.i8.i64(<vscale x 4 x i16> undef, <vscale x 4 x i8> %30, i8 %36, i64 16)
  %38 = getelementptr inbounds nuw i8, ptr %32, i64 2
  %39 = load i8, ptr %38, align 2
  %40 = tail call <vscale x 4 x i16> @llvm.riscv.vwmul.nxv4i16.nxv4i8.i8.i64(<vscale x 4 x i16> undef, <vscale x 4 x i8> %30, i8 %39, i64 16)
  %41 = getelementptr inbounds nuw i8, ptr %32, i64 3
  %42 = load i8, ptr %41, align 1
  %43 = tail call <vscale x 4 x i16> @llvm.riscv.vwmul.nxv4i16.nxv4i8.i8.i64(<vscale x 4 x i16> undef, <vscale x 4 x i8> %30, i8 %42, i64 16)
  %44 = getelementptr inbounds nuw i8, ptr %32, i64 4
  %45 = load i8, ptr %44, align 4
  %46 = tail call <vscale x 4 x i16> @llvm.riscv.vwmul.nxv4i16.nxv4i8.i8.i64(<vscale x 4 x i16> undef, <vscale x 4 x i8> %30, i8 %45, i64 16)
  %47 = getelementptr inbounds nuw i8, ptr %32, i64 5
  %48 = load i8, ptr %47, align 1
  %49 = tail call <vscale x 4 x i16> @llvm.riscv.vwmul.nxv4i16.nxv4i8.i8.i64(<vscale x 4 x i16> undef, <vscale x 4 x i8> %30, i8 %48, i64 16)
  %50 = getelementptr inbounds nuw i8, ptr %32, i64 6
  %51 = load i8, ptr %50, align 2
  %52 = tail call <vscale x 4 x i16> @llvm.riscv.vwmul.nxv4i16.nxv4i8.i8.i64(<vscale x 4 x i16> undef, <vscale x 4 x i8> %30, i8 %51, i64 16)
  %53 = getelementptr inbounds nuw i8, ptr %32, i64 7
  %54 = load i8, ptr %53, align 1
  %55 = tail call <vscale x 4 x i16> @llvm.riscv.vwmul.nxv4i16.nxv4i8.i8.i64(<vscale x 4 x i16> undef, <vscale x 4 x i8> %30, i8 %54, i64 16)
  %56 = tail call <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32> undef, <16 x i32> %22, i64 0)
  %57 = tail call <vscale x 4 x i32> @llvm.riscv.vwadd.w.nxv4i32.nxv4i16.i64(<vscale x 4 x i32> %56, <vscale x 4 x i32> %56, <vscale x 4 x i16> %34, i64 16)
  %58 = tail call <16 x i32> @llvm.vector.extract.v16i32.nxv4i32(<vscale x 4 x i32> %57, i64 0)
  %59 = tail call <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32> undef, <16 x i32> %23, i64 0)
  %60 = tail call <vscale x 4 x i32> @llvm.riscv.vwadd.w.nxv4i32.nxv4i16.i64(<vscale x 4 x i32> %59, <vscale x 4 x i32> %59, <vscale x 4 x i16> %37, i64 16)
  %61 = tail call <16 x i32> @llvm.vector.extract.v16i32.nxv4i32(<vscale x 4 x i32> %60, i64 0)
  %62 = tail call <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32> undef, <16 x i32> %24, i64 0)
  %63 = tail call <vscale x 4 x i32> @llvm.riscv.vwadd.w.nxv4i32.nxv4i16.i64(<vscale x 4 x i32> %62, <vscale x 4 x i32> %62, <vscale x 4 x i16> %40, i64 16)
  %64 = tail call <16 x i32> @llvm.vector.extract.v16i32.nxv4i32(<vscale x 4 x i32> %63, i64 0)
  %65 = tail call <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32> undef, <16 x i32> %25, i64 0)
  %66 = tail call <vscale x 4 x i32> @llvm.riscv.vwadd.w.nxv4i32.nxv4i16.i64(<vscale x 4 x i32> %65, <vscale x 4 x i32> %65, <vscale x 4 x i16> %43, i64 16)
  %67 = tail call <16 x i32> @llvm.vector.extract.v16i32.nxv4i32(<vscale x 4 x i32> %66, i64 0)
  %68 = tail call <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32> undef, <16 x i32> %26, i64 0)
  %69 = tail call <vscale x 4 x i32> @llvm.riscv.vwadd.w.nxv4i32.nxv4i16.i64(<vscale x 4 x i32> %68, <vscale x 4 x i32> %68, <vscale x 4 x i16> %46, i64 16)
  %70 = tail call <16 x i32> @llvm.vector.extract.v16i32.nxv4i32(<vscale x 4 x i32> %69, i64 0)
  %71 = tail call <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32> undef, <16 x i32> %27, i64 0)
  %72 = tail call <vscale x 4 x i32> @llvm.riscv.vwadd.w.nxv4i32.nxv4i16.i64(<vscale x 4 x i32> %71, <vscale x 4 x i32> %71, <vscale x 4 x i16> %49, i64 16)
  %73 = tail call <16 x i32> @llvm.vector.extract.v16i32.nxv4i32(<vscale x 4 x i32> %72, i64 0)
  %74 = tail call <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32> undef, <16 x i32> %28, i64 0)
  %75 = tail call <vscale x 4 x i32> @llvm.riscv.vwadd.w.nxv4i32.nxv4i16.i64(<vscale x 4 x i32> %74, <vscale x 4 x i32> %74, <vscale x 4 x i16> %52, i64 16)
  %76 = tail call <16 x i32> @llvm.vector.extract.v16i32.nxv4i32(<vscale x 4 x i32> %75, i64 0)
  %77 = tail call <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32> undef, <16 x i32> %29, i64 0)
  %78 = tail call <vscale x 4 x i32> @llvm.riscv.vwadd.w.nxv4i32.nxv4i16.i64(<vscale x 4 x i32> %77, <vscale x 4 x i32> %77, <vscale x 4 x i16> %55, i64 16)
  %79 = tail call <16 x i32> @llvm.vector.extract.v16i32.nxv4i32(<vscale x 4 x i32> %78, i64 0)
  %80 = insertvalue [8 x <16 x i32>] poison, <16 x i32> %58, 0
  %81 = insertvalue [8 x <16 x i32>] %80, <16 x i32> %61, 1
  %82 = insertvalue [8 x <16 x i32>] %81, <16 x i32> %64, 2
  %83 = insertvalue [8 x <16 x i32>] %82, <16 x i32> %67, 3
  %84 = insertvalue [8 x <16 x i32>] %83, <16 x i32> %70, 4
  %85 = insertvalue [8 x <16 x i32>] %84, <16 x i32> %73, 5
  %86 = insertvalue [8 x <16 x i32>] %85, <16 x i32> %76, 6
  %87 = insertvalue [8 x <16 x i32>] %86, <16 x i32> %79, 7
  %88 = add nuw nsw i64 %18, 1, !dbg !86
  %exitcond.not = icmp eq i64 %88, 64, !dbg !86
  br i1 %exitcond.not, label %89, label %16, !dbg !86

89:                                               ; preds = %16
  %.idx = shl nuw nsw i64 %10, 10, !dbg !86
  %90 = getelementptr i8, ptr %7, i64 %.idx, !dbg !86
  %.idx30 = shl nuw nsw i64 %11, 6, !dbg !86
  %91 = getelementptr i8, ptr %90, i64 %.idx30, !dbg !86
  store <16 x i32> %58, ptr %91, align 64, !dbg !86
  %92 = getelementptr i8, ptr %91, i64 128, !dbg !86
  store <16 x i32> %61, ptr %92, align 64, !dbg !86
  %93 = getelementptr i8, ptr %91, i64 256, !dbg !86
  store <16 x i32> %64, ptr %93, align 64, !dbg !86
  %94 = getelementptr i8, ptr %91, i64 384, !dbg !86
  store <16 x i32> %67, ptr %94, align 64, !dbg !86
  %95 = getelementptr i8, ptr %91, i64 512, !dbg !86
  store <16 x i32> %70, ptr %95, align 64, !dbg !86
  %96 = getelementptr i8, ptr %91, i64 640, !dbg !86
  store <16 x i32> %73, ptr %96, align 64, !dbg !86
  %97 = getelementptr i8, ptr %91, i64 768, !dbg !86
  store <16 x i32> %76, ptr %97, align 64, !dbg !86
  %98 = getelementptr i8, ptr %91, i64 896, !dbg !86
  store <16 x i32> %79, ptr %98, align 64, !dbg !86
  ret i32 0, !dbg !86
}

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: write, target_mem0: none, target_mem1: none)
define internal noundef i32 @_encoding_0_encode_32x64xi8_to_32x64xi8(ptr noalias nonnull readnone align 16 captures(none) %0, ptr noalias noundef nonnull readonly align 16 captures(none) %1, ptr noalias noundef nonnull readonly align 16 captures(none) %2) #0 !dbg !87 {
  ...
  %5 = getelementptr i8, ptr %.unpack20, i64 8, !dbg !88
  %6 = load ptr, ptr %5, align 8, !dbg !88
  call void @llvm.assume(i1 true) [ "align"(ptr %6, i64 64) ], !dbg !88
  %7 = load i32, ptr %2, align 16, !dbg !88
  %8 = zext i32 %7 to i64, !dbg !88
  %9 = shl nuw nsw i64 %8, 4, !dbg !88
  %10 = and i64 %9, 48, !dbg !88
  %11 = shl nuw nsw i64 %8, 7
  %12 = and i64 %11, 549755813376
  %13 = getelementptr i8, ptr %4, i64 %12
  %14 = getelementptr i8, ptr %6, i64 %12
  br label %15, !dbg !88

15:                                               ; preds = %3, %15
  %16 = phi i64 [ 0, %3 ], [ %49, %15 ]
  %17 = or disjoint i64 %16, %10, !dbg !88
  %18 = getelementptr i8, ptr %13, i64 %17, !dbg !88
  %19 = load <1 x i8>, ptr %18, align 1, !dbg !88
  %20 = getelementptr i8, ptr %18, i64 64, !dbg !88
  %21 = load <1 x i8>, ptr %20, align 1, !dbg !88
  %22 = getelementptr i8, ptr %18, i64 128, !dbg !88
  %23 = load <1 x i8>, ptr %22, align 1, !dbg !88
  %24 = shufflevector <1 x i8> %23, <1 x i8> poison, <8 x i32> <i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %25 = getelementptr i8, ptr %18, i64 192, !dbg !88
  %26 = load <1 x i8>, ptr %25, align 1, !dbg !88
  %27 = shufflevector <1 x i8> %26, <1 x i8> poison, <8 x i32> <i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %28 = getelementptr i8, ptr %18, i64 256, !dbg !88
  %29 = load <1 x i8>, ptr %28, align 1, !dbg !88
  %30 = shufflevector <1 x i8> %29, <1 x i8> poison, <8 x i32> <i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %31 = getelementptr i8, ptr %18, i64 320, !dbg !88
  %32 = load <1 x i8>, ptr %31, align 1, !dbg !88
  %33 = shufflevector <1 x i8> %32, <1 x i8> poison, <8 x i32> <i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %34 = getelementptr i8, ptr %18, i64 384, !dbg !88
  %35 = load <1 x i8>, ptr %34, align 1, !dbg !88
  %36 = shufflevector <1 x i8> %35, <1 x i8> poison, <8 x i32> <i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %37 = getelementptr i8, ptr %18, i64 448, !dbg !88
  %38 = load <1 x i8>, ptr %37, align 1, !dbg !88
  %39 = shufflevector <1 x i8> %38, <1 x i8> poison, <8 x i32> <i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %40 = shufflevector <1 x i8> %19, <1 x i8> %21, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>, !dbg !88
  %41 = shufflevector <8 x i8> %40, <8 x i8> %24, <8 x i32> <i32 0, i32 1, i32 8, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>, !dbg !88
  %42 = shufflevector <8 x i8> %41, <8 x i8> %27, <8 x i32> <i32 0, i32 1, i32 2, i32 8, i32 poison, i32 poison, i32 poison, i32 poison>, !dbg !88
  %43 = shufflevector <8 x i8> %42, <8 x i8> %30, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 poison, i32 poison, i32 poison>, !dbg !88
  %44 = shufflevector <8 x i8> %43, <8 x i8> %33, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 8, i32 poison, i32 poison>, !dbg !88
  %45 = shufflevector <8 x i8> %44, <8 x i8> %36, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 8, i32 poison>, !dbg !88
  %46 = shufflevector <8 x i8> %45, <8 x i8> %39, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 8>, !dbg !88
  %47 = shl nuw nsw i64 %17, 3, !dbg !88
  %48 = getelementptr i8, ptr %14, i64 %47, !dbg !88
  store <8 x i8> %46, ptr %48, align 8, !dbg !88
  %49 = add nuw nsw i64 %16, 1, !dbg !88
  %exitcond.not = icmp eq i64 %49, 16, !dbg !88
  br i1 %exitcond.not, label %50, label %15, !dbg !88
...
define internal noundef i32 @_encoding_1_encode_64x32xi8_to_64x32xi8(ptr noalias nonnull readnone align 16 captures(none) %0, ptr noalias noundef nonnull readonly align 16 captures(none) %1, ptr noalias noundef nonnull readonly align 16 captures(none) %2) #1 !dbg !89 {
  ...
  %7 = getelementptr i8, ptr %6, i64 2048, !dbg !90
  call void @llvm.assume(i1 true) [ "align"(ptr %7, i64 64) ], !dbg !90
  %8 = load i32, ptr %2, align 16, !dbg !90
  %9 = zext i32 %8 to i64, !dbg !90
  %10 = lshr i64 %9, 6, !dbg !90
  %11 = and i64 %9, 63, !dbg !90
  %12 = shl nuw nsw i64 %10, 4, !dbg !90
  %13 = shl nuw nsw i64 %11, 5, !dbg !90
  %14 = getelementptr i8, ptr %4, i64 %13, !dbg !90
  %15 = getelementptr i8, ptr %14, i64 %12, !dbg !90
  %16 = load <16 x i8>, ptr %15, align 16, !dbg !90
  %17 = shl nuw nsw i64 %10, 10, !dbg !90
  %18 = shl nuw nsw i64 %11, 4, !dbg !90
  %19 = getelementptr i8, ptr %7, i64 %17, !dbg !90
  %20 = getelementptr i8, ptr %19, i64 %18, !dbg !90
  store <16 x i8> %16, ptr %20, align 16, !dbg !90
  ret i32 0, !dbg !90
}
...
declare <vscale x 4 x i8> @llvm.vector.insert.nxv4i8.v16i8(<vscale x 4 x i8>, <16 x i8>, i64 immarg) #3

; Function Attrs: mustprogress nocallback nofree nosync nounwind willreturn memory(none)
declare <vscale x 4 x i16> @llvm.riscv.vwmul.nxv4i16.nxv4i8.i8.i64(<vscale x 4 x i16>, <vscale x 4 x i8>, i8, i64) #4

; Function Attrs: mustprogress nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare <vscale x 4 x i32> @llvm.vector.insert.nxv4i32.v16i32(<vscale x 4 x i32>, <16 x i32>, i64 immarg) #3

; Function Attrs: mustprogress nocallback nofree nosync nounwind willreturn memory(none)
declare <vscale x 4 x i32> @llvm.riscv.vwadd.w.nxv4i32.nxv4i16.i64(<vscale x 4 x i32>, <vscale x 4 x i32>, <vscale x 4 x i16>, i64) #4
...
attributes #4 = { mustprogress nocallback nofree nosync nounwind willreturn memory(none) "frame-pointer"="all" "hot" "no-builtins" "nonlazybind" }
...
!9 = !{!"Simple C/C++ TBAA"}
!10 = distinct !DISubprogram(name: "matmul_i8_quantized_dispatch_0_matmul_32x32x64_i8xi8xi32", linkageName: "matmul_i8_quantized_dispatch_0_matmul_32x32x64_i8xi8xi32", scope: !1, file: !1, line: 1, type: !11, scopeLine: 1, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0)
...
!87 = distinct !DISubprogram(name: "_encoding_0_encode_32x64xi8_to_32x64xi8", linkageName: "_encoding_0_encode_32x64xi8_to_32x64xi8", scope: !1, file: !1, line: 1, type: !11, scopeLine: 1, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !2)
!88 = !DILocation(line: 1, column: 1, scope: !87)
!89 = distinct !DISubprogram(name: "_encoding_1_encode_64x32xi8_to_64x32xi8", linkageName: "_encoding_1_encode_64x32xi8_to_64x32xi8", scope: !1, file: !1, line: 1, type: !11, scopeLine: 1, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !3)
