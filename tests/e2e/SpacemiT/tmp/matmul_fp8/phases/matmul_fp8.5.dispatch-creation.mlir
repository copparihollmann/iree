...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  util.func public @matmul_fp8(%arg0: !hal.buffer_view, %arg1: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub, iree.reflection = {iree.abi.declaration = "sync func @matmul_fp8(%input0: tensor<32x64xf8E4M3FN>, %input1: tensor<64x32xf8E4M3FN>) -> (%output0: tensor<32x32xf16>)"}} {
    ...
    %4 = flow.dispatch.workgroups(%2, %3) : (tensor<32x64xf8E4M3FN, #encoding>, tensor<64x32xf8E4M3FN, #encoding1>) -> tensor<32x32xf16> =
        (%arg2: !iree_tensor_ext.dispatch.tensor<readonly:tensor<32x64xf8E4M3FN, #encoding>>, %arg3: !iree_tensor_ext.dispatch.tensor<readonly:tensor<64x32xf8E4M3FN, #encoding1>>, %arg4: !iree_tensor_ext.dispatch.tensor<writeonly:tensor<32x32xf16>>) {
      %cst = arith.constant 0.000000e+00 : f16
      %6 = iree_tensor_ext.dispatch.tensor.load %arg2, offsets = [0, 0], sizes = [32, 64], strides = [1, 1] : !iree_tensor_ext.dispatch.tensor<readonly:tensor<32x64xf8E4M3FN, #encoding>> -> tensor<32x64xf8E4M3FN, #encoding>
      %7 = iree_tensor_ext.dispatch.tensor.load %arg3, offsets = [0, 0], sizes = [64, 32], strides = [1, 1] : !iree_tensor_ext.dispatch.tensor<readonly:tensor<64x32xf8E4M3FN, #encoding1>> -> tensor<64x32xf8E4M3FN, #encoding1>
      %8 = tensor.empty() : tensor<32x32xf16, #encoding2>
      %9 = linalg.fill ins(%cst : f16) outs(%8 : tensor<32x32xf16, #encoding2>) -> tensor<32x32xf16, #encoding2>
      %10 = linalg.matmul ins(%6, %7 : tensor<32x64xf8E4M3FN, #encoding>, tensor<64x32xf8E4M3FN, #encoding1>) outs(%9 : tensor<32x32xf16, #encoding2>) -> tensor<32x32xf16, #encoding2>
      %11 = iree_encoding.unset_encoding %10 : tensor<32x32xf16, #encoding2> -> tensor<32x32xf16>
      iree_tensor_ext.dispatch.tensor.store %11, %arg4, offsets = [0, 0], sizes = [32, 32], strides = [1, 1] : tensor<32x32xf16> -> !iree_tensor_ext.dispatch.tensor<writeonly:tensor<32x32xf16>>
      flow.return
