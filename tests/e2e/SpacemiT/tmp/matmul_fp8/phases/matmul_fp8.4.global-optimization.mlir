...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  util.func public @matmul_fp8(%arg0: !hal.buffer_view, %arg1: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub, iree.reflection = {iree.abi.declaration = "sync func @matmul_fp8(%input0: tensor<32x64xf8E4M3FN>, %input1: tensor<64x32xf8E4M3FN>) -> (%output0: tensor<32x32xf16>)"}} {
    ...
    %1 = iree_tensor_ext.compute_barrier.start %0 : tensor<32x64xf8E4M3FN> -> tensor<32x64xf8E4M3FN>
    %2 = hal.tensor.import %arg1 "input1" : !hal.buffer_view -> tensor<64x32xf8E4M3FN>
    %3 = iree_tensor_ext.compute_barrier.start %2 : tensor<64x32xf8E4M3FN> -> tensor<64x32xf8E4M3FN>
    %4 = tensor.empty() : tensor<32x32xf16>
    %5 = linalg.fill ins(%cst : f16) outs(%4 : tensor<32x32xf16>) -> tensor<32x32xf16>
    %6 = linalg.matmul ins(%1, %3 : tensor<32x64xf8E4M3FN>, tensor<64x32xf8E4M3FN>) outs(%5 : tensor<32x32xf16>) -> tensor<32x32xf16>
    %7 = iree_tensor_ext.compute_barrier.end %6 : tensor<32x32xf16> -> tensor<32x32xf16>
    %8 = hal.tensor.export %7 "output0" : tensor<32x32xf16> -> !hal.buffer_view
