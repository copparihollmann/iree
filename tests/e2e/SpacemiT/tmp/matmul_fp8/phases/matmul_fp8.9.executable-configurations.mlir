#config = #iree_cpu.lowering_config<cache_parallel = [4, 16], vector_common_parallel = [4, 4]>
#config1 = #iree_cpu.lowering_config<cache_parallel = [4, 16, 0], distribution = [4, 16, 0], vector_common_parallel = [4, 4, 0], vector_reduction = [0, 0, 8]>
...
#translation1 = #iree_codegen.translation_info<pipeline = CPUDefault>
...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  hal.executable private @matmul_fp8_dispatch_0 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @matmul_fp8_dispatch_0_matmul_32x32x64_f8E4M3FNxf8E4M3FNxf16() attributes {translation_info = #translation} {
          ...
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c2048) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<64x32xf8E4M3FN>>
          ...
          %3 = iree_tensor_ext.dispatch.tensor.load %0, offsets = [0, 0], sizes = [32, 64], strides = [1, 1] : !iree_tensor_ext.dispatch.tensor<readonly:tensor<32x64xf8E4M3FN>> -> tensor<32x64xf8E4M3FN>
          %4 = iree_tensor_ext.dispatch.tensor.load %1, offsets = [0, 0], sizes = [64, 32], strides = [1, 1] : !iree_tensor_ext.dispatch.tensor<readonly:tensor<64x32xf8E4M3FN>> -> tensor<64x32xf8E4M3FN>
          %5 = tensor.empty() : tensor<32x32xf16>
          %6 = linalg.fill {lowering_config = #config} ins(%cst : f16) outs(%5 : tensor<32x32xf16>) -> tensor<32x32xf16>
          %7 = linalg.matmul {lowering_config = #config1} ins(%3, %4 : tensor<32x64xf8E4M3FN>, tensor<64x32xf8E4M3FN>) outs(%6 : tensor<32x32xf16>) -> tensor<32x32xf16>
          iree_tensor_ext.dispatch.tensor.store %7, %2, offsets = [0, 0], sizes = [32, 32], strides = [1, 1] : tensor<32x32xf16> -> !iree_tensor_ext.dispatch.tensor<writeonly:tensor<32x32xf16>>
          return
        }
      }
    }
  ...
  hal.executable private @_encoding_0 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @_encoding_0_encode_32x64xf8E4M3FN_to_32x64xf8E4M3FN() attributes {translation_info = #translation1} {
          %c0 = arith.constant 0 : index
          %0 = hal.interface.binding.subspan layout(#pipeline_layout) binding(0) alignment(64) offset(%c0) flags("ReadOnly|Indirect") : !iree_tensor_ext.dispatch.tensor<readonly:tensor<32x64xf8E4M3FN>>
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c0) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<32x64xf8E4M3FN>>
          ...
          iree_tensor_ext.dispatch.tensor.store %2, %1, offsets = [0, 0], sizes = [32, 64], strides = [1, 1] : tensor<32x64xf8E4M3FN> -> !iree_tensor_ext.dispatch.tensor<writeonly:tensor<32x64xf8E4M3FN>>
          return
        }
      }
    }
  ...
  hal.executable private @_encoding_1 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @_encoding_1_encode_64x32xf8E4M3FN_to_64x32xf8E4M3FN() attributes {translation_info = #translation1} {
          %c0 = arith.constant 0 : index
          %c2048 = arith.constant 2048 : index
          ...
          %1 = hal.interface.binding.subspan layout(#pipeline_layout) binding(1) alignment(64) offset(%c2048) flags(Indirect) : !iree_tensor_ext.dispatch.tensor<writeonly:tensor<64x32xf8E4M3FN>>
          ...
          iree_tensor_ext.dispatch.tensor.store %2, %1, offsets = [0, 0], sizes = [64, 32], strides = [1, 1] : tensor<64x32xf8E4M3FN> -> !iree_tensor_ext.dispatch.tensor<writeonly:tensor<64x32xf8E4M3FN>>
          return
        }
      }
    }
