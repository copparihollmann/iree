...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  flow.executable private @matmul_i8_dispatch_0 {
    flow.executable.export public @matmul_i8_dispatch_0_matmul_32x32x64_i8xi8xi32 workgroups() -> (index, index, index) {
      %x, %y, %z = iree_tensor_ext.dispatch.workgroup_count_from_slice()
      flow.return %x, %y, %z : index, index, index
    }
    builtin.module {
      func.func @matmul_i8_dispatch_0_matmul_32x32x64_i8xi8xi32(%arg0: !iree_tensor_ext.dispatch.tensor<readonly:tensor<32x64xi8, #encoding>>, %arg1: !iree_tensor_ext.dispatch.tensor<readonly:tensor<64x32xi8, #encoding1>>, %arg2: !iree_tensor_ext.dispatch.tensor<writeonly:tensor<32x32xi32>>) {
  ...
  util.func public @matmul_i8(%arg0: !hal.buffer_view, %arg1: !hal.buffer_view) -> !hal.buffer_view attributes {iree.abi.stub, iree.reflection = {iree.abi.declaration = "sync func @matmul_i8(%input0: tensor<32x64xi8>, %input1: tensor<64x32xi8>) -> (%output0: tensor<32x32xi32>)"}} {
    ...
    %4 = flow.dispatch @matmul_i8_dispatch_0::@matmul_i8_dispatch_0_matmul_32x32x64_i8xi8xi32(%2, %3) : (tensor<32x64xi8, #encoding>, tensor<64x32xi8, #encoding1>) -> tensor<32x32xi32>
