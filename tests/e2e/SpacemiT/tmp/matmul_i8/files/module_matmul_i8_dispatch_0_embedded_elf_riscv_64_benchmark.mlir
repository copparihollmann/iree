module {
  ...
  util.global private mutable @matmul_i8_dispatch_0_embedded_elf_riscv_64_matmul_i8_dispatch_0_matmul_32x32x64_i8xi8xi32_buffer : !hal.buffer
  util.initializer {
    ...
    util.global.store %buffer, @matmul_i8_dispatch_0_embedded_elf_riscv_64_matmul_i8_dispatch_0_matmul_32x32x64_i8xi8xi32_buffer : !hal.buffer
    util.return
  }
  util.func public @matmul_i8_dispatch_0_embedded_elf_riscv_64_matmul_i8_dispatch_0_matmul_32x32x64_i8xi8xi32(%arg0: i32) attributes {iree.abi.stub, iree.reflection = {iree.benchmark = "dispatch"}} {
    %0 = arith.index_cast %arg0 : i32 to index
    %device, %queue_affinity = hal.device.resolve on(#hal.device.affinity<@__device_0>) : !hal.device, i64
    %cmd = hal.command_buffer.create device(%device : !hal.device) mode("OneShot|AllowInlineExecution") categories(Dispatch) affinity(%queue_affinity) : !hal.command_buffer
    %matmul_i8_dispatch_0_embedded_elf_riscv_64_matmul_i8_dispatch_0_matmul_32x32x64_i8xi8xi32_buffer = util.global.load @matmul_i8_dispatch_0_embedded_elf_riscv_64_matmul_i8_dispatch_0_matmul_32x32x64_i8xi8xi32_buffer : !hal.buffer
    %c0 = arith.constant 0 : index
    %c4096 = arith.constant 4096 : index
    %workgroup_x, %workgroup_y, %workgroup_z = hal.executable.calculate_workgroups device(%device : !hal.device) target(@matmul_i8_dispatch_0::@embedded_elf_riscv_64::@matmul_i8_dispatch_0_matmul_32x32x64_i8xi8xi32) : index, index, index
    %exe = hal.executable.lookup device(%device : !hal.device) executable(@matmul_i8_dispatch_0) : !hal.executable
    %ordinal = hal.executable.export.ordinal target(@matmul_i8_dispatch_0::@embedded_elf_riscv_64::@matmul_i8_dispatch_0_matmul_32x32x64_i8xi8xi32) : index
    %c1 = arith.constant 1 : index
    scf.for %arg1 = %c0 to %0 step %c1 {
      hal.command_buffer.dispatch<%cmd : !hal.command_buffer> target(%exe : !hal.executable)[%ordinal] workgroups([%workgroup_x, %workgroup_y, %workgroup_z]) bindings([
        (%matmul_i8_dispatch_0_embedded_elf_riscv_64_matmul_i8_dispatch_0_matmul_32x32x64_i8xi8xi32_buffer : !hal.buffer)[%c0, %c4096], 
        (%matmul_i8_dispatch_0_embedded_elf_riscv_64_matmul_i8_dispatch_0_matmul_32x32x64_i8xi8xi32_buffer : !hal.buffer)[%c4096, %c4096]
      ]) flags("None")
