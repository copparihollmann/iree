...
module attributes {stream.affinity.default = #hal.device.affinity<@__device_0>} {
  ...
  hal.executable private @conv_i8_dispatch_0 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @conv_i8_dispatch_0_generic_32x32x3x3x8_i8() attributes {translation_info = #translation} {
  ...
  hal.executable private @conv_i8_dispatch_1 {
    hal.executable.variant public @embedded_elf_riscv_64 target(#executable_target_embedded_elf_riscv_64) {
      ...
      builtin.module {
        func.func @conv_i8_dispatch_1_matmul_1024x16x72_i8xi8xi32() attributes {translation_info = #translation1} {
