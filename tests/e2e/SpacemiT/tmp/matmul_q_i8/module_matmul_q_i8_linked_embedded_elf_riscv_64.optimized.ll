...
@4 = internal constant [141 x i8] c"/scratch2/agustin/merlin/third_party/iree_bar/tests/e2e/SpacemiT/tmp/matmul_q_i8/files/configured_module_matmul_i8_quantized_dispatch_0.mlir\00", align 1
@5 = internal constant [122 x i8] c"/scratch2/agustin/merlin/third_party/iree_bar/tests/e2e/SpacemiT/tmp/matmul_q_i8/files/configured_module__encoding_0.mlir\00", align 1
@6 = internal constant [122 x i8] c"/scratch2/agustin/merlin/third_party/iree_bar/tests/e2e/SpacemiT/tmp/matmul_q_i8/files/configured_module__encoding_1.mlir\00", align 1
@iree_hal_executable_library_query_v0_source_locations = internal constant [3 x %iree_hal_executable_source_location_v0_t] [%iree_hal_executable_source_location_v0_t { i32 3, i32 140, ptr @4 }, %iree_hal_executable_source_location_v0_t { i32 3, i32 121, ptr @5 }, %iree_hal_executable_source_location_v0_t { i32 3, i32 121, ptr @6 }]
