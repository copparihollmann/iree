	.attribute	4, 16
	.attribute	5, "rv64i2p1_m2p0_a2p1_f2p2_d2p2_c2p0_v1p0_zicsr2p0_zmmul1p0_zaamo1p0_zalrsc1p0_zca1p0_zcd1p0_zve32f1p0_zve32x1p0_zve64d1p0_zve64f1p0_zve64x1p0_zvl128b1p0_zvl32b1p0_zvl64b1p0"
...
.Lfunc_begin0:
	.file	1 "/scratch2/agustin/merlin/third_party/iree_bar/tests/e2e/OPU/tmp/matmul_q_i8_xopu_zvl128/files" "configured_module_matmul_i8_quantized_dispatch_0.mlir"
	.loc	1 1 0
	.cfi_startproc
	addi	sp, sp, -96
...
.LBB0_1:
	...
	addi	s8, s8, -96
	vl4r.v	v12, (s8)
	opu.vmv.rv	m0, zero, v12
	csrr	s8, vlenb
	slli	s8, s8, 5
	sub	s8, s0, s8
	addi	s8, s8, -96
	vl4r.v	v12, (s8)
	opu.vmv.rv	m0, a6, v12
	csrr	s8, vlenb
	li	ra, 28
	mul	s8, s8, ra
	sub	s8, s0, s8
	...
	addi	s8, s8, -96
	vl4r.v	v12, (s8)
	opu.vmv.rv	m0, t1, v12
	csrr	s8, vlenb
	slli	s8, s8, 4
	sub	s8, s0, s8
	addi	s8, s8, -96
	vl4r.v	v12, (s8)
	opu.vmv.rv	m0, t2, v12
	csrr	s8, vlenb
	li	ra, 12
	mul	s8, s8, ra
	sub	s8, s0, s8
	addi	s8, s8, -96
	vl4r.v	v12, (s8)
	opu.vmv.rv	m0, t3, v12
	csrr	s8, vlenb
	slli	s8, s8, 2
	sub	s8, s0, s8
	addi	s8, s8, -96
	vl4r.v	v12, (s8)
	opu.vmv.rv	m0, t4, v12
	opu.vmv.rv	m0, t6, v8
	opu.vmv.rv	m0, s3, v0
	opu.vmv.rv	m0, s5, v4
	opu.vmv.rv	m0, s6, v28
	opu.vmv.rv	m0, s7, v24
	opu.vmv.rv	m0, s1, v20
	opu.vmv.rv	m0, a2, v16
	csrr	s8, vlenb
	slli	s8, s8, 3
	sub	s8, s0, s8
	addi	s8, s8, -96
	...
	opu.vmv.vr	v0, s3, m0
	opu.vmv.vr	v4, s5, m0
	opu.vmv.vr	v28, s6, m0
	opu.vmv.vr	v24, s7, m0
	opu.vmv.vr	v20, s1, m0
	opu.vmv.vr	v16, a2, m0
	opu.vmv.vr	v12, a5, m0
	csrr	s8, vlenb
	slli	s8, s8, 3
	sub	s8, s0, s8
	addi	s8, s8, -96
...
.Lfunc_begin1:
	.file	2 "/scratch2/agustin/merlin/third_party/iree_bar/tests/e2e/OPU/tmp/matmul_q_i8_xopu_zvl128/files" "configured_module__encoding_0.mlir"
	.loc	2 1 0 is_stmt 1
	.cfi_startproc
	addi	sp, sp, -16
...
.Lfunc_begin2:
	.file	3 "/scratch2/agustin/merlin/third_party/iree_bar/tests/e2e/OPU/tmp/matmul_q_i8_xopu_zvl128/files" "configured_module__encoding_1.mlir"
	.loc	3 1 0
	.cfi_startproc
	addi	sp, sp, -16
	.cfi_def_cfa_offset 16
...
__unnamed_5:
	.asciz	"/scratch2/agustin/merlin/third_party/iree_bar/tests/e2e/OPU/tmp/matmul_q_i8_xopu_zvl128/files/configured_module_matmul_i8_quantized_dispatch_0.mlir"
	.size	__unnamed_5, 148

	.type	__unnamed_6,@object
	.section	.rodata.__unnamed_6,"a",@progbits
__unnamed_6:
	.asciz	"/scratch2/agustin/merlin/third_party/iree_bar/tests/e2e/OPU/tmp/matmul_q_i8_xopu_zvl128/files/configured_module__encoding_0.mlir"
	.size	__unnamed_6, 129

	.type	__unnamed_7,@object
	.section	.rodata.__unnamed_7,"a",@progbits
__unnamed_7:
	.asciz	"/scratch2/agustin/merlin/third_party/iree_bar/tests/e2e/OPU/tmp/matmul_q_i8_xopu_zvl128/files/configured_module__encoding_1.mlir"
	.size	__unnamed_7, 129
...
.Linfo_string0:
	.asciz	"IREE"
.Linfo_string1:
	.asciz	"configured_module_matmul_i8_quantized_dispatch_0.mlir"
.Linfo_string2:
	.asciz	"/scratch2/agustin/merlin/third_party/iree_bar/tests/e2e/OPU/tmp/matmul_q_i8_xopu_zvl128/files"
.Linfo_string3:
